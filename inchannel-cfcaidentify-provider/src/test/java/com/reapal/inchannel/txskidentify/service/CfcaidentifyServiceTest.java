//package com.reapal.inchannel.txskidentify.service;//package com.reapal.inchannel.cfcaidentify.service;
//
...
//})
//public class CfcaidentifyServiceTest {
//
//    @Autowired
//    private CfcaIdentifyService cfcaIdentifyService;
//
//    @Test
//    public void crud() {
//
...
////        req.setCardNo("6212260200089765230");
//        req.setCertNo("41038119930427656X");
//        req.setOwner("袁玫");
////        req.setPhone("18311233172");
//        InchannelIdentifyResponse result = cfcaIdentifyService.realName(req);
//
...
////                result = cfcaIdentifyService.identify(req);
