...
//            map.put("idCardCode", "123456789012345678");
//            map.put("idCardName", "张三");
////            map.put("idCardCode", "142302199011283716");
////            map.put("idCardName", "吴小辉");
//
//
//            // map.put("idCardCore", certId);
//            // map.put("bankPreMobile", phone);
//
//            // 请求业务参数详细
//            Map<String, String> getRequestTokenSign = LklSubmit.getSign(map);
//
//            Map  sParaTempToken = new HashMap();
//            sParaTempToken.put("customerId", "201504300000000001");
//            sParaTempToken.put("sign", getRequestTokenSign.get(LklDict.SIGN));
//            sParaTempToken.put("reqData", getRequestTokenSign.get(LklDict.REQDATA));
//            sParaTempToken.put("prdGrpId", "identityQuery");
//            sParaTempToken.put("prdId", "queryIDCard");
//            System.out.println(sParaTempToken);
//            System.out.println("===="+HttpUtils.doPost("https://fw.kaolazhengxin.com/authentication.do"+"?_t=json", sParaTempToken, 30000, 30000));
//        } catch (IOException e) {
