package com.reapal.inchannel.chinapay.utils;
...
/*
    public static void main(String[] args) {
        try {
            ...
            System.out.println(WebUtils.doPost("http://www.woshidai.com/modules/account/return.php", new HashMap(), 30000, 30000));
        } catch (IOException e) {
