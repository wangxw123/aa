 ...
 */
  ...
  //日期段星期列表
	...
	public static int getAgeYear(String outTime,String birth){
		Date outTimeDate= com.reapal.common.util.DateUtil.parseDate(outTime);
		Date birthDate= com.reapal.common.util.DateUtil.parseDate(birth);
	...
	public static  Date[] getPre15Day(Date nowDate){
		...
		for(int j = 0; j<30; j++){
			if(j==0){
				preDateStr = com.reapal.common.util.DateUtil.format(nowDate);
				weekStr = com.reapal.common.util.DateUtil.getDayOfWeek(preDateStr);
			}else{
				preDate = com.reapal.common.util.DateUtil.addDate(nowDate, com.reapal.common.util.DateUtil.DAY, -1);
				preDateStr = com.reapal.common.util.DateUtil.toString(preDate);
				weekStr = com.reapal.common.util.DateUtil.getDayOfWeek(preDateStr);
				nowDate = preDate;
			}
			if(!"六".equals(weekStr) && !"日".equals(weekStr)){
				dayCount++;
				if(dayCount==15){
					String dateStr = com.reapal.common.util.DateUtil.format(nowDate);
					String weekS = com.reapal.common.util.DateUtil.getDayOfWeek(dateStr);
					if("一".equals(weekS)){
						resultDate[0] = nowDate;
						resultDate[1] = com.reapal.common.util.DateUtil.addDate(nowDate, com.reapal.common.util.DateUtil.DAY, -1);
						resultDate[2] = com.reapal.common.util.DateUtil.addDate(nowDate, com.reapal.common.util.DateUtil.DAY, -2);
					}else{
						resultDate[0] = nowDate;
					}
				}
